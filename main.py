...
def main():
    ...
    for table in tables:
        try:
            ...
            transaction_data = settings['tables'][tables.index(table)]['transaction_data']
            pipeline.run_pipeline(table_name=table, exclude_columns=exclude_columns, transaction_data=transaction_data)
